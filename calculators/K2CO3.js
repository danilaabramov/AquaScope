    ...
    return (//рендер компонентов
        <View style={styles.container}>
            <View style={{marginTop: 5, paddingBottom: 10, flexDirection: "row"}}>
                ...
                <Text style={[styles.sectionTitle, {color: colors.text}]}>K2CO3</Text>
            </View>
            <ScrollView   showsVerticalScrollIndicator={false} contentContainerStyle={{flexGrow: 1}} keyboardShouldPersistTaps='handled'>
                ...
                <View style={[styles.textInput, {backgroundColor: colors.background2, color: colors.text, marginTop: 15, padding: 15}]}>
                    ...
                    <Text style={{color: colors.text}}>Концентрация после добавления 1 мл раствора K2CO3 </Text>
                    
                    {/*Расчёт концентрации Калия */}
                    <Text style={{color: colors.text}}>K: {(((1.30308338*numOfSalt/2.30308338)/solutionVol*1000/volume)).toFixed([3])} ppm </Text>
                    
                    {/*Расчёт концентрации CO3 */}
                    <Text style={{color: colors.text}}>CO3: {((((1.30308338*numOfSalt/2.30308338)*0.767410604)/solutionVol*1000/volume)).toFixed([3])} ppm</Text>
