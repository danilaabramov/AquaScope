        ...
        <View style={styles.container}>
            ...
            <ScrollView   showsVerticalScrollIndicator={false} contentContainerStyle={{flexGrow: 1}} keyboardShouldPersistTaps='handled'>
                ...
                <View style={[styles.textInput, {backgroundColor: colors.background2, color: colors.text, marginTop: 15, padding: 15}]}>
                    ...
                    <Text style={{color: colors.text}}>K: {(((1.30308338*value3/2.30308338)/value2*1000/value1)).toFixed([3])} ppm </Text>
                    <Text style={{color: colors.text}}>CO3: {((((1.30308338*value3/2.30308338)*0.767410604)/value2*1000/value1)).toFixed([3])} ppm</Text>
