       ...
       <View style={styles.container}>
            ...
            <ScrollView   showsVerticalScrollIndicator={false} contentContainerStyle={{flexGrow: 1}} keyboardShouldPersistTaps='handled'>
                ...
                <View style={[styles.textInput, {backgroundColor: colors.background2, color: colors.text, marginTop: 15, padding: 15}]}>
                    ...
                    <Text style={{color: colors.text}}>Концентрация после добавления 1 мл раствора K2SO4 </Text>
                    
                    {/*Расчёт концентрации Калия */}
                    <Text style={{color: colors.text}}>K: {(((0.81401711*numOfSalt/1.81401711)/solutionVol*1000/volume)).toFixed([3])} ppm </Text>
                    
                     {/*Расчёт концентрации SO4 */}
                    <Text style={{color: colors.text}}>SO4: {((((0.81401711*numOfSalt/1.81401711)*1.22847541)/solutionVol*1000/volume)).toFixed([3])} ppm</Text>
