       ...
       <View style={styles.container}>
            ...
            <ScrollView   showsVerticalScrollIndicator={false} contentContainerStyle={{flexGrow: 1}} keyboardShouldPersistTaps='handled'>
                ...
                <View style={[styles.textInput, {backgroundColor: colors.background2, color: colors.text, marginTop: 15, padding: 15}]}>
                    ...
                    <Text style={{color: colors.text}}>K: {(((0.81401711*value3/1.81401711)/value2*1000/value1)).toFixed([3])} ppm </Text>
                    <Text style={{color: colors.text}}>SO4: {((((0.81401711*value3/1.81401711)*1.22847541)/value2*1000/value1)).toFixed([3])} ppm</Text>
